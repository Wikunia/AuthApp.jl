...
# !!! Main.UserApp is configured as an alias for Main.AuthApp and you might encounter it in some tests
using Main.AuthApp, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "AuthApp tests" begin
  @includetests ARGS
end
